mv /opt/conda/envs/deepspeed_env/lib/python3.11/site-packages/deepspeed/moe /opt/conda/envs/deepspeed_env/lib/python3.10/site-packages/deepspeed/moe_org
cp -r /opt/conda/envs/deepspeed_env/lib/python3.10/site-packages/deepspeed/moe_org /opt/conda/envs/deepspeed_env/lib/python3.11/site-packages/deepspeed/moe
...
cp ../../moe/sharded_moe_tutel.py /opt/conda/envs/deepspeed_env/lib/python3.11/site-packages/deepspeed/moe/sharded_moe.py
